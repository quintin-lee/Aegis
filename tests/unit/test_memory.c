...
static void test_generic_put_get(void)
{
    ...
    aegis_memory_item_t* item = make_item("id1", "hello world", AEGIS_MEMORY_ITEM_GOAL, 5);
...
static void test_working_no_capacity_limit(void)
{
    ...
    for (int i = 0; i < 10; i++) {
        ...
        aegis_memory_item_t* item = make_item(id, content, AEGIS_MEMORY_ITEM_GOAL, i);
...
static void test_procedural_search(void)
{
    ...
    aegis_memory_item_t* ex1 =
        make_item("ex1", "use hash map for caching", AEGIS_MEMORY_ITEM_EXPERIENCE, 1);
    aegis_memory_item_t* ex2 =
        make_item("ex2", "avoid deep recursion", AEGIS_MEMORY_ITEM_EXPERIENCE, 2);
    aegis_memory_item_t* ex3 =
        make_item("ex3", "hash map lookup is fast", AEGIS_MEMORY_ITEM_EXPERIENCE, 3);
...
{
    _flush();
    printf("starting null_safe_api();... ");
    fflush(stdout);
    test_null_safe_api();
    ;
    printf("ok\n");
    printf("starting invalid_args();... ");
    fflush(stdout);
    test_invalid_args();
    ;
    printf("ok\n");
    printf("starting generic_put_get();... ");
    fflush(stdout);
    test_generic_put_get();
    ;
    printf("ok\n");
    printf("starting generic_remove();... ");
    fflush(stdout);
    test_generic_remove();
    ;
    printf("ok\n");
    printf("starting generic_remove_not_found();... ");
    fflush(stdout);
    test_generic_remove_not_found();
    ;
    printf("ok\n");
    printf("starting generic_remove_borrow();... ");
    fflush(stdout);
    test_generic_remove_borrow();
    ;
    printf("ok\n");
    printf("starting generic_search_by_type();... ");
    fflush(stdout);
    test_generic_search_by_type();
    ;
    printf("ok\n");
    printf("starting generic_overwrite();... ");
    fflush(stdout);
    test_generic_overwrite();
    ;
    printf("ok\n");
    printf("starting working_capacity_eviction();... ");
    fflush(stdout);
    test_working_capacity_eviction();
    ;
    printf("ok\n");
    printf("starting working_no_capacity_limit();... ");
    fflush(stdout);
    test_working_no_capacity_limit();
    ;
    printf("ok\n");
    printf("starting episodic_append_range();... ");
    fflush(stdout);
    test_episodic_append_range();
    ;
    printf("ok\n");
    printf("starting semantic_overwrite();... ");
    fflush(stdout);
    test_semantic_overwrite();
    ;
    printf("ok\n");
    printf("starting semantic_not_found();... ");
    fflush(stdout);
    test_semantic_not_found();
    ;
    printf("ok\n");
    printf("starting procedural_search();... ");
    fflush(stdout);
